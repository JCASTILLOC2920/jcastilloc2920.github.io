      ...
      laminas: [
        {
          id: "L13-00",
          codigo: "L-HEP-00",
          diagnostico: "Hepatitis Crónica Viral (Pieza Necrosis / Necrosis en Sacabocados)",
          organo: "Hígado (Espacios porta y parénquima periportal)",
          tincion: "H&E / Reticulina",
          aumentoRecomendado: "20X - 40X",
          tipoLesion: "Inflamación crónica hepatocitaria necroinflamatoria",
          definicionRobbins: "Inflamación hepática continua persistente por más de 6 meses; caracterizada por infiltrado mononuclear portal, hepatitis de interfase (necrosis en sacabocados) y cuerpos apoptóticos de Councilman.",
          triadaPatognomonica: [
            "Hepatitis de interfase (piecemeal necrosis): infiltrado linfoplasmocitario portal que rebasa la placa limitante y erosiona los hepatocitos adyacentes.",
            "Infiltrado inflamatorio portal denso linfoide, con formación de folículos linfoides prominentes (muy característicos de Hepatitis C).",
            "Cuerpos apoptóticos de Councilman (hepatocitos picnóticos intensamente eosinófilos redondos) y hepatocitos en vidrio esmerilado en VHB (ground-glass)."
          ],
          perlaDiagnostica: "Los hepatocitos en 'vidrio esmerilado' (ground-glass hepatocytes) contienen abundante antígeno de superficie HBsAg en el retículo endoplásmico liso.",
          metaforaVisual: "Linfocitos atacando la empalizada de hepatocitos de la placa limitante como olas rompiendo contra un malecón.",
          diagnosticoDiferencial: [
            "Hepatitis aguda viral (necrosis panlobulillar balonizante difusa sin folículos portales consolidados ni fibrosis)",
            "Hepatitis autoinmune (predominio masivo de células plasmáticas e hipergammaglobulinemia)"
          ],
          enlacesMicroscopia: {
            webpath: "https://webpath.med.utah.edu/LIVERHTML/LIVER004.html",
            pathpresenter: "https://pathpresenter.net/",
            histologyGuide: "https://histologyguide.com/"
          }
        },
